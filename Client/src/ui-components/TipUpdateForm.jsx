...
export default function TipUpdateForm(props) {
  const {
    id: idProp,
    tip: tipModelProp,
    onSuccess,
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Tip, idProp) : tipModelProp;
      setTipRecord(record);
    };
    queryData();
  }, [idProp, tipModelProp]);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "TipUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || tipModelProp)}
